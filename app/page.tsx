...
export default function Home() {
  ...
  const featuredProjects = [
    ...
    {
      title: "Aether",
      description: "Privacy-first desktop email client. Gmail over OAuth, with AI summaries and context-aware replies generated by a local LLM (Ollama + llama3.2) running alongside the app — no email content leaves your machine.",
      period: "February 2025",
      technologies: ["Electron", "React", "TypeScript", "SQLite", "Ollama", "Flask"],
      githubUrl: "https://github.com/AdvaitTahilyani/Aether"
    },
    {
      title: "Chess Mimic Bot",
      description: "Neural net that learns your personal chess style. Pulls your Chess.com games, estimates your Lichess-equivalent ELO, pre-trains a 10-block residual policy network on same-rating games, then fine-tunes on your own moves. The /chess page on this site is a shared live game you can play against me right now.",
      period: "April 2026",
      technologies: ["PyTorch", "ResNet", "python-chess", "Chess.com API", "Lichess"],
      liveUrl: "/chess",
      githubUrl: "https://github.com/AdvaitTahilyani/Chess"
    },
    {
      title: "Toy Shell",
  ...
  const otherProjects = [
    {
      title: "NoteTaker",
      description: "macOS SwiftUI client paired with a local Flask server. Whisper transcribes uploaded audio and Phi-3 (via Ollama) turns the transcript into a structured Word doc — fully offline.",
      period: "Jan 2024 – May 2025",
      technologies: ["Swift", "Flask", "Whisper", "Phi-3", "Ollama"],
